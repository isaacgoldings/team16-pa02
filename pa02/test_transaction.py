...
def test_db(empty_db):
    trans1 = {'itemNum':'1', 'amount':'20', 'category':'rent', 'date':'2022-3-24', 'description':'test'}
    trans2 = {'itemNum':'2', 'amount':'30', 'category':'food', 'date':'2021-5-24', 'description':'testa'}
    trans3 = {'itemNum':'3', 'amount':'40', 'category':'utilities', 'date':'1492-6-29', 'description':'testb'}
...
def test_add(test_db):
    ...
    # yield len(db)
    # assert len(db) == 3
    # recent = test_db.add(trans0)
    # assert len(db) == 4

    # assert recent['itemNum']=='4'
    # assert recent['amount']=='50'
    # assert recent['category']=='test1'
    # assert recent['date']=='2500-1-10'
    # assert recent['description']=='testadd'
